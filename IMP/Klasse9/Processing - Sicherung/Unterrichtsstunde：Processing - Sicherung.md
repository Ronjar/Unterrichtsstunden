...
### Zusammenfassung
*Verschiedene einfache optische Täuschungen, die sich die Schülerinnen selbst aussuchen können*
...
const pdfsInFolder = allFiles.filter(f => 
    f.extension === 'pdf' && f.path.startsWith('IMP/Klasse9/Processing - Sicherung/AB')
);
